...
export default function LinkZakatTransactionsDrawer({
  isOpen,
  onClose,
  dateFrom,
  dateTo,
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    try {
      ...
      if (!result.success) {
        toast.error(
          typeof result.error === "string" ? result.error : "Failed to link Zakat payment",
        );
        return;
      }
      ...
      toast.error(error instanceof Error ? error.message : "Failed to link Zakat payment");
    } finally {
      setIsSaving(false);
    }
  });
            ...
            <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-800">
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
                  Link Zakat Transactions
                </h2>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Link imported transactions to Zakat payments.
                </p>
              </div>
              <button
                type="button"
                        ...
                        <button
                          ...
                          className={`w-full rounded-md border p-3 text-left transition ${
                            selected
                              ...
                              : "border-gray-200 hover:border-blue-300 hover:bg-gray-50 dark:border-gray-800 dark:hover:border-blue-700 dark:hover:bg-gray-800"
                          }`}
                        >
                  ...
                  <div className="rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-950">
                    {selectedTransaction ? (
                      ...
                      <p className="text-sm text-gray-500">
                        Select a transaction from the left to link it.
                      </p>
                    )}
                  </div>
