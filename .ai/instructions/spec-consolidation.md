...
Look up the feature in `.ai/instructions/spec-migration-map.md`:
...
2. **Delegate to gpt-4.1 agent**
   - Use template from `.ai/instructions/migration-agent-template.md` § "Agent Task Template: Migrate One Domain"
...
- **Where's the domain for feature Y?** → Check `.ai/instructions/spec-migration-map.md`
- **How do I migrate?** → Use template in `.ai/instructions/migration-agent-template.md`
