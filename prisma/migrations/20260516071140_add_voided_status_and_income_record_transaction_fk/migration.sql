/*
  ...
  - A unique constraint covering the columns `[transactionId]` on the table `IncomeRecord` will be added. If there are existing duplicate values, this will fail.

*/
-- AlterEnum
ALTER TYPE "ImportStatusEnum" ADD VALUE 'VOIDED';

-- AlterEnum
ALTER TYPE "TransactionStatusEnum" ADD VALUE 'VOIDED';
